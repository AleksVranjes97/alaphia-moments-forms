    ...
    const content = (
        <div>
            ...
            <div className="content-div">
                ...
                <label for="one">I want to avoid repeating something negative that happened in the past</label><br></br>
                <br />
                <input type="radio" 
                       id="two"
                       name="avoidOutcome"
                       ...
                       onChange={handleChange} />
                <label for="two">I am trying to avoid something negative happening in the future</label><br></br>
                <br />
                <input type="radio" 
                       id="three"
                       name="avoidOutcome"
                       ...
                       onChange={handleChange} />
                <label for="three">I am trying to recreate something positive that happened in the past</label><br></br>
                <br />
                <input type="radio" 
                       id="four"
                       name="avoidOutcome"
                       ...
                       onChange={handleChange} />
                <label for="four">I am trying to create a positive future outcome</label><br></br>
                <br />
                <input type="radio" 
                       id="five"
                       name="avoidOutcome"
